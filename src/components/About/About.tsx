  ...
  <FullScreenSection name="about">
    <Container>
      ...
      <p>
        ...
        fucking issue, and that the existence of JavaScript has become a bane to humanity&apos;s
        shitty existence, yet forgot that web performance is something that requires some TLC and
        actual fucking effort, and all of the page bloat hoohah doesn&apos;t even matter as much
        anymore.
      </p>
      <p>
