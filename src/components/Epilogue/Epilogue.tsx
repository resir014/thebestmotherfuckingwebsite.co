  ...
  <FullScreenSection name="epilogue">
    <Container>
      ...
      <p>
        ...
        , but the average size of video games have exponentially grown as well. In fact, the
        developers of No Man's Sky tried to make their procedurally-generated game as small as they
        can. Look how well that turned out.
      </p>
      <p>
        My point is, sure, page bloat matters to a degree, but it matters less than what it used to
        be. Sure, the JavaScript platform is exploding like diarrhea, and we've seen a lot of shitty
