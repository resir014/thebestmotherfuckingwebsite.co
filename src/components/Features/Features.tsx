      ...
      <Row style={{ paddingTop: '4rem', paddingBottom: '4rem' }}>
        <Col>
          <div className={classnames(styles.featureBox, styles.guessWhat)}>
            ...
            <p>
              Look at this fucking beauty. It&apos;s sleek. It loads faster than you can even take a shit. And not to mention that it still
              has all the glory of a perfect-ass website:
            </p>
            <ul>
              ...
              <li>
                Is entirely <a href="https://github.com/resir014/thebestmotherfuckingwebsite.co">open source</a>.
              </li>
            </ul>
            <p>
              <small>
        ...
        <Row>
          <Col>
            <div className={styles.innerBox}>
              ...
              <p>
                I&apos;m gonna level with you. I&apos;m suffering from a rare health condition known as &quot;CSS-itis&quot;. It prevents me
                from doing productive shit with, and even touching a single line of CSS, if I could help it. I never thought I would see the
                light of day.
              </p>
              <p>
                Here&apos;s a solution: CSS-in-JS. I know it sounds counterintuitive, but hear me out. Designing through CSS is already a
                pain in the ass, especially with globally-scoped classes that will be happy to fuck you over when your CSS gets large. Thank
                fuck for{' '}
                <a href="https://github.com/css-modules/css-modules" target="_blank" rel="noopener noreferrer">
                  CSS Modules
                </a>
                , which takes your existing CSS and solves all of the scoping issues through some JS magic. There&apos;s also a lot of other
                options, like{' '}
